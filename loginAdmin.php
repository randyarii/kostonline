<?php
	...
	$query=mysql_query("select * from tabel_logadmin where username='$username' and password='$password'");	 //melakukan pengambilan data dari database untuk di cocokkan
	...
	if($xxx==TRUE){ 		// melakukan pemeriksaan kecocokan dengan percabangan.
		...
		header("location:halamanadmin.php");     // dan alihkan ke index.php
